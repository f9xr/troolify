/* ============================================================================
   ...
   3. Rewrites every reference to a managed asset to its minified sibling:
   ...
   4. Minifies each managed JS (terser) and CSS (clean-css) file in place,
...
function swapFontLinks(html, prefix) {
  ...
  // cdnjs preconnect is only useful for the icon font we now host locally
...
async function run() {
  ...
  let utt = 0, strip = 0, href = 0, refs = 0, fonts = 0, htmlMin = 0;
